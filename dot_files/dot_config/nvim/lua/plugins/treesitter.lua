return {
    ...
    config = function()
        ...
        configs.setup({
            ...
            ensure_installed = {
                "awk", "bash", "c", "cmake", "css", "dockerfile", "git_rebase", "gitattributes", "gitcommit",
                "gitignore", "html", "java", "javascript", "json", "latex", "lua", "make", "markdown", "python",
                "regex", "rust", "sql", "vim", "yaml"
            },
